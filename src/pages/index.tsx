  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Information System - Empowering employers with comprehensive management of employee data, vacations, and payroll, all in one place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Information System - Empowering employers with comprehensive management of employee data, vacations, and payroll, all in one place.`}
            </Text>
            <Box
